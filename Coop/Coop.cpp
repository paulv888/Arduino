...
void aliveMessage() {
	...
	devices[DEVICE_0_IDX].setValue(FREEMEMORY, (String)freeMemory());
	devices[DEVICE_0_IDX].setValue(UPTIME, (String)millis());
	devices[DEVICE_0_IDX].setValue(INTERNALTEMP, (String)GetInternalTemp());
